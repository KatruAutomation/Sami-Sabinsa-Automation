...
public class Distributor_RegularRegistrationPage {
	...
	By nopan = By.xpath("//input[@type='checkbox'][@ng-model='registration.isNoPan']");
	...
	By sbtfom = By.xpath("/html/body/div[2]/ng-view/div/div[1]/form/section[9]/div/div/div/div/div/div[2]/button");
	...
	public void advfirmname() {
		...
		driver.findElement(submt).click();
			...
			//driver.findElement(nopan).click();
